...
- Brunaga, Elías Mainque.
- Bujakiewicz, Ignacio Sebastián.
...
Este proyecto consiste en un sistema de gestión de estacionamiento desarrollado en Python y ejecutado por consola. El sistema permite registrar el ingreso y egreso de vehículos, calcular el importe a pagar según el tiempo de permanencia y el tipo de vehículo, controlar los espacios disponibles y mostrar estadísticas generales del estacionamiento.
...
El desarrollo del proyecto se realizó utilizando GitHub, registrando el proceso de construcción mediante commits periódicos durante la implementación de las distintas funcionalidades.
